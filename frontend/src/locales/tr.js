...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymFLOSS locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de GymFLOSS’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install GymFLOSS as a full-screen app.': 'ile GymFLOSS’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if GymFLOSS is closed.': 'GymFLOSS kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own GymFLOSS — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi GymFLOSS\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
