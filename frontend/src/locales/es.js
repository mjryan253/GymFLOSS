...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymFLOSS locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar GymFLOSS localmente en este dispositivo.',
  ...
  'to install GymFLOSS as a full-screen app.': 'para instalar GymFLOSS como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if GymFLOSS is closed.': 'Avisos del temporizador de descanso, incluso con GymFLOSS cerrado.',
  ...
  'A small file a friend imports into their own GymFLOSS — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio GymFLOSS: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload GymFLOSS': 'Recargar GymFLOSS',
