...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymFLOSS locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst GymFLOSS trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install GymFLOSS as a full-screen app.': 'um GymFLOSS als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if GymFLOSS is closed.': 'Pausen-Timer-Alarm, auch wenn GymFLOSS geschlossen ist.',
  ...
  'A small file a friend imports into their own GymFLOSS — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes GymFLOSS importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'Reload GymFLOSS': 'GymFLOSS neu laden',
