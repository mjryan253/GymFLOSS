# Contributing to GymFLOSS

Thanks for taking a look! GymFLOSS is intentionally small and dependency-light, and the goal is
...
| You have | Goes to |
| --- | --- |
| A question, or self-hosting that won't behave | [Discussions → Q&A](https://github.com/mjryan253/GymFLOSS/discussions/categories/q-a) |
| An idea you're not sure about yet | [Discussions → Ideas](https://github.com/mjryan253/GymFLOSS/discussions/categories/ideas) |
