...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymFLOSS locally on this device.": 'Этот браузер не поддерживает ключи доступа — но GymFLOSS можно использовать локально на этом устройстве.',
  ...
  'to install GymFLOSS as a full-screen app.': 'чтобы установить GymFLOSS как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if GymFLOSS is closed.': 'Оповещения таймера отдыха, даже если GymFLOSS закрыт.',
  ...
  'A small file a friend imports into their own GymFLOSS — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой GymFLOSS — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload GymFLOSS': 'Перезагрузить GymFLOSS',
